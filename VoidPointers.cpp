...
void typeCastToAllDataTypes(void * long_ptr, void * float_ptr, void * char_ptr, void * str_ptr) {
	...
	printf("Value stored at long_ptr is %f\n", *(float *)float_ptr);
...
void task7() {
	...
	printf("%f",(float *)getFloatAsVoidStar());
	printf("%d", (int *)getIntAsVoidStar());
	printf("%s", (char *)getStringAsVoidStar());
